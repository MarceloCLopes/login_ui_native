    ...
    <SafeAreaView className="bg-white h-full w-full">
      ...
      <View className="h-full w-full flex justify-around pt-40 pb-10">
        <View className="flex items-center">
          <Animated.Text entering={FadeInUp.duration(1000).springify()} className="text-5xl font-bold tracking-wide text-white mt-4">Login</Animated.Text>
        </View>
        ...
        <View className="flex items-center mx-4 space-y-4">
          ...
          <Animated.View entering={FadeInDown.delay(600).duration(1000).springify()} className="flex-row justify-center space-x-1">
